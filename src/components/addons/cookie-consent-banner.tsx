            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm leading-relaxed text-gray-600">
                  We use cookies and similar technologies to help personalize content, tailor and measure ads, and provide a better experience. By clicking "Accept All", you agree to our use of cookies. Read our <a href="/privacy-policy" className="text-blue-600 font-medium hover:underline">Privacy Policy</a> for more details.
                </p>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Control which cookies you want to allow.</p>
                </div>
                <button 
              ...
              <div className="grid gap-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="pr-4">
                    <p className="font-bold text-gray-900 text-sm">Essential Cookies</p>
                    <p className="text-xs text-gray-500">Required for basic site functionality and security.</p>
                  </div>
                ...
                <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                  <div className="pr-4">
                    <p className="font-bold text-gray-900 text-sm">Analytics Cookies</p>
                    <p className="text-xs text-gray-500">Help us improve our website by collecting information on how you use it.</p>
                  </div>
                ...
                <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                  <div className="pr-4">
                    <p className="font-bold text-gray-900 text-sm">Marketing Cookies</p>
                    <p className="text-xs text-gray-500">Used to show you more relevant advertisements based on your interests.</p>
                  </div>
                  <div className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
