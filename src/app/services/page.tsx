...
import { CheckCircle2, Rocket, Layout, BarChart } from "lucide-react"

export const metadata = {
  title: "Služby",
  description: "Preskúmajte naše balíčky tvorby webov a SEO služieb."
}
      ...
      <section className="py-24 bg-background border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {[ 
              { step: "01", title: "Úvodná konzultácia (Pred štartom)", desc: "Spojíme sa, pochopíme váš biznis, ciele a cieľovú skupinu. Zhromaždíme všetky podklady, texty a obrázky predtým, než začne plynúť náš týždeň." },
              { step: "02", title: "Prvá verzia do 24 hodín (Pondelok)", desc: "Vytvoríme základnú štruktúru a dizajn na základe našich dohovorov. Už v utorok ráno uvidíte prvý hmatateľný výsledok, na ktorom budeme ďalej stavať." },
              { step: "03", title: "Týždeň ladenia (Utorok - Štvrtok)", desc: "Implementujeme vaše pripomienky, plníme web obsahom, nastavujeme SEO, animácie a prepojujeme formuláre. Vy máte neustály prístup k testovacej verzii." },
              { step: "04", title: "Spustenie a odovzdanie (Piatok)", desc: "Robíme finálne testy na všetkých zariadeniach a prehliadačoch. Po vašom schválení web presúvame na vašu doménu a spúšťame ho do ostrej prevádzky." }
            ].map((item, index) => (
